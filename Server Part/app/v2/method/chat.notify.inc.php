...
if (!empty($_POST)) {
    ...
    $result = array("error" => false,
                    ...
                    "android_msg_fcm_regid" => $android_msg_fcm_regid,
                    "ios_msg_fcm_regid" => $ios_msg_fcm_regid,
    ...
    if ($profileId == $accountId) {
        ...
        if (strlen($android_fcm_regId) > 0 || strlen($ios_fcm_regId) > 0 || strlen($android_msg_fcm_regid) > 0 || strlen($ios_msg_fcm_regid) > 0) {
            ...
            $fcm->addDeviceId($android_msg_fcm_regid);
            $fcm->addDeviceId($ios_msg_fcm_regid);
