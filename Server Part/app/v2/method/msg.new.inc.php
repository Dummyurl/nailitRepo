...
if (!empty($_POST)) {
    ...
    if (!$profileInfo['inBlackList']) {
        ...
        $result = $messages->create($profileId, $chatId, $messageText, $messageImg, $chatFromUserId, $chatToUserId, $profileInfo['gcm_regid'], $listId, $profileInfo['ios_fcm_regid'], $stickerId, $stickerImgUrl, $profileInfo['android_msg_fcm_regid'], $profileInfo['ios_msg_fcm_regid']);
    }
