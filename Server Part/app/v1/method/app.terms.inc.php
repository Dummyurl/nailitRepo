...
<p>The text you have to write your own, because one person has forbidden me to use "words" :) I'm sorry, but I have no right to write the test in this section :) Now I will write only code :)
    <br>
    <br>
    Say "thank you" to this good man :)
    <br>
    <br>
    Please edit the file: app/v1/method/app.terms.inc.php</p>
</body>
</html>