<?php
    ...
    if (!empty($_POST)) {
        ...
        if (!$blacklist->isExists(auth::getCurrentUserId())) {
            ...
            $result = $messages->create($user_id, $chat_id, $message_text, $message_img, 0, 0, $profileInfo['gcm_regid'], 0, $profileInfo['ios_fcm_regid'], "", "", $profileInfo['android_msg_fcm_regid'], $profileInfo['ios_msg_fcm_regid']);
