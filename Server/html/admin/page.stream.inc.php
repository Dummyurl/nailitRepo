                ...
                <div class="col s8">
                    <div class="card">
                        ...
                        <div class="card-action">
                            ...
                            <a href="javascript: void(0)" onclick="Post.remove('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'removeByIp'); return false;">Delete All With this IP</a>
                            <a href="javascript: void(0)" onclick="Stoplist.action('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'add'); return false;">Add IP to Stoplist</a>
                            <a href="javascript: void(0)" onclick="Stoplist.action('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'remove'); return false;">Remove IP from Stoplist</a>
                        </div>
                    </div>
                </div>
            </div>
