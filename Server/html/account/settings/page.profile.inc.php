<?php
    ...
    if (!empty($_POST)) {
        ...
        $allowPhotosComments = isset($_POST['allowPhotosComments']) ? $_POST['allowPhotosComments'] : '';
        ...
        $allowPhotosComments = helper::clearText($allowPhotosComments);
        $allowPhotosComments = helper::escapeText($allowPhotosComments);
        ...
        if (!$error) {
            ...
            if ($allowPhotosComments === "on") {

                $account->setAllowPhotosComments(1);

            } else {

                $account->setAllowPhotosComments(0);
            }
                    ...
                    <form accept-charset="UTF-8" action="/account/settings/profile" autocomplete="off" class="edit_user" id="settings-form" method="post">
                        ...
                        <div class="tabbed-content">
                            ...
                            <div class="tab-pane active form-table">
                                ...
                                <div class="link-preference form-row">
                                    <div class="form-cell left">
                                        <h2><?php echo $LANG['label-images-privacy']; ?></h2>
                                    </div>

                                    <div class="form-cell">
                                        <div class="opt-in">
                                            <input id="allowPhotosComments" name="allowPhotosComments" type="checkbox" <?php if ($accountInfo['allowPhotosComments'] == 1) echo "checked=\"checked\""; ?>>
                                            <label for="allowPhotosComments"><?php echo $LANG['label-images-comments-allow']; ?></label>
                                        </div>
                                    </div>
                                </div>
