<?php
        ...
        if ($inbox_loaded != 0) {
            ...
            if ($result['inbox_loaded'] < $inbox_all) {
                ...
                <header class="top-banner loading-banner">
                    ...
                    <div class="prompt">
                        <button onclick="Feeds.more('<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
    ...
    $css_files = array("main.css", "my.css", "main.css");
            ...
            <div class="main-content">
                ...
                <div class="standard-page page-title-content">
                    <div class="page-title-content-inner">
                        <?php echo $LANG['page-wall']; ?>
                    </div>
                    <div class="page-title-content-bottom-inner">
                        <?php echo $LANG['page-news-description']; ?>
                    </div>
                </div>
                ...
                <div class="standard-page tabs-content">
                    <div class="tab-container">
                        <nav class="tabs">
                            <a href="/account/wall"><span class="tab active"><?php echo $LANG['page-wall']; ?></span></a>
