<?php
    ...
    $page_title = "Search Users and Communities";
            ...
            <div class="card">
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col s2">
                                <h4>Search Users and Communities</h4>
                            </div>
                        </div>
                        ...
                        <form method="get" action="/admin/users">
                            ...
                            <div class="row">
                                <div class="input-field col s7">
                                    ...
                                    <label for="query">Find users/communities by username, full name, email. Minimum of 3 characters.</label>
                                </div>
                                        ...
                                        <div class="col s12">
                                            <div class="card blue-grey darken-1">
                                                <div class="card-content white-text">
                                                    <span class="card-title">Enter in the search box username, communities, full name or email. Minimum of 3 characters.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php
    ...
    function draw($user)
    {
        ...
        <tr>
            ...
            <td><?php if ($user['account_type'] == 0) {echo "User";} else {echo "Community";} ?></td>
            <td><?php echo $user['username']; ?></td>
            <td><?php echo $user['fullname']; ?></td>
            <td><?php if (strlen($user['fb_id']) < 2) {echo "Not connected to facebook.";} else {echo "<a target=\"_blank\" href=\"https://www.facebook.com/app_scoped_user_id/{$user['fb_id']}\">Facebook account link</a>";} ?></td>
            ...
            <td><?php if ($user['account_type'] == 0) {echo "<a href=\"/admin/profile/?id={$user['id']}\">Edit</a>";} else {echo "<a href=\"/admin/group/?id={$user['id']}\">Edit</a>";} ?></td>
        </tr>
